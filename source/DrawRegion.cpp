...
int main(int argc, char **argv)
{
  ...
  // Los primeros 3 puntos son la coordenada inicial?
  // Los 3 ultimos son cuanto avanzara en dicho eje<
  // Por eso en el pokemon, las 3 primeras son las coordenadas, y los 3 ultimos son las dimensiones a partir de esas coordenadas
  vtkNew<vtkActor> cubeActor1 = drawRegion(5, 5, 5,10, 5, 20);
  //vtkNew<vtkActor> cubeActor2 = drawRegion(1, 1, 1, 2, 8, 2);
  ...
  renderer->AddActor(drawPoint(0,0,0));
